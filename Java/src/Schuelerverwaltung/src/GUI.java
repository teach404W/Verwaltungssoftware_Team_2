...
public class GUI {
    ...
    public GUI() throws Exception {
        ...
        sync_Box.setFont(new Font("Times new Roman", Font.PLAIN, 60)); // Die Schriftart von sync_Box eingeben | "Times
                                                                       // New Roman" ist die Schriftart und 60 ist die
                                                                       // Schriftgröße
        sync_Box.setBounds(900, 500, 250, 145); // Die Position von sync_Box setten (x Position, y Position, x Größe, y
                                                // Größe) | Wenn die x und y Positionen 0 sind, dann wird sync_Box oben
        ...
        sync[0] = new JButton("Ja"); // definieren von sync[0] | der Text in den Klammern "Ja" ist der Anfangstext
        ...
        sync[0].setFont(new Font("Times new Roman", Font.PLAIN, 30)); // Die Schriftart von sync[0] eingeben | Die
                                                                      // Schriftart ist "Times new Roman" und die
                                                                      // Schriftgröße ist 30
        sync[0].setBounds(920, 550, 100, 30); // Die Position von sync_Box setten (x Position, y Position, x Größe, y
                                              // Größe) | Wenn die x und y Positionen 0 sind, dann wird sync_Box oben
                                              // auf der linken Ecke sein
        ...
        sync[0].setActionCommand("LoadData"); // Actioncommand wird beim Klicken genommen und kann Funktionen starten.
        ...
        sync_Text = new JTextArea("           Willst du die \n gespeicherten Daten laden?"); // Text von sync_Text
                                                                                             // setten. \n ist nextline
        sync_Text.setForeground(new Color(255, 255, 255)); // Textfarbe mit rgb(rot, grün, blau) setten
        sync_Text.setFont(new Font("Times new Roman", Font.PLAIN, 22)); // Schriftart eingebn | "Times New Roman" ist
                                                                        // die Schriftart und 22 ist die Schriftgröße
        ...
        optionI[1].setIcon(new ImageIcon(new ImageIcon("Java\\src\\Schuelerverwaltung\\Images\\Menü\\Karten.png")
        ...
        optionI[2].setIcon(
                new ImageIcon(new ImageIcon("Java\\src\\Schuelerverwaltung\\Images\\Menü\\Karte bearbeiten.png")
        ...
        optionI[3].setIcon(new ImageIcon(new ImageIcon("Java\\src\\Schuelerverwaltung\\Images\\Menü\\Remove.png")
        ...
        optionI[4].setIcon(new ImageIcon(new ImageIcon("Java\\src\\Schuelerverwaltung\\Images\\Menü\\Würfel2.png")
                .getImage().getScaledInstance(36, 40,
                        Image.SCALE_AREA_AVERAGING)));
        ...
        optionI[5].setIcon(new ImageIcon(new ImageIcon("Java\\src\\Schuelerverwaltung\\Images\\Menü\\Abmelden.png")
                .getImage().getScaledInstance(36, 40,
                        Image.SCALE_AREA_AVERAGING)));
        ...
        iRandomButton.setIcon(new ImageIcon(new ImageIcon("Java\\src\\Schuelerverwaltung\\Images\\Others\\Würfel.png")
                .getImage().getScaledInstance(50, 45, Image.SCALE_AREA_AVERAGING)));
        ...
        iSaveButton.setIcon(new ImageIcon(new ImageIcon("Java\\src\\Schuelerverwaltung\\Images\\Others\\Save.png")
                .getImage().getScaledInstance(50, 45, Image.SCALE_AREA_AVERAGING)));
